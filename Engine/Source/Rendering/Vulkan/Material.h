...
namespace Nova::Vulkan
{
    ...
    public:
        ...
        void SetTexture(StringView name, Ref<Nova::TextureView> textureView) override;
        void SetSamplerAndTexture(StringView name, Ref<Nova::Sampler> sampler, Ref<Nova::TextureView> textureView) override;
