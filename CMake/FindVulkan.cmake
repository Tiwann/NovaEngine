...
.. code-block:: cmake
  ...
  find_package(VulkanCustom [COMPONENTS <components>...])
...
``Vulkan::glslang``
  ...
  Target encapsulating the ``slang`` library usage requirements, available if
  ``slang`` is found in the SDK.
...
``Vulkan::slang``
  ...
  Target encapsulating the ``slang`` library usage requirements,
  available if this library is found in the SDK.
...
``Vulkan_slang_FOUND``
  ...
  Boolean indicating whether the SDK provides the ``slang`` library.
...
.. code-block:: cmake
  ...
  find_package(VulkanCustom COMPONENTS volk)
