...
namespace Nova
{
    ...
    void Matrix4::Rotate(const Vector3& Axis, const f32 Radians)
    {
    ...
    void Matrix4::RotateDegrees(const Vector3& Axis, const f32 Degrees)
    {
        *this = Math::RotateAxisAngleDegrees(*this, Axis, Degrees);
    }

    void Matrix4::Scale(const f32 Scalar)
    {
