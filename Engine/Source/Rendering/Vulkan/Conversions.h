...
namespace Nova::Vulkan
{
    ...
    inline VkShaderStageFlags Convert(const ShaderStageFlags& value)
    {
        ...
        if (val & (uint32_t)ShaderStageFlagBits::TessellationEvaluation)
    ...
    inline VkShaderStageFlagBits Convert(const ShaderStageFlagBits& value)
    {
        ...
        case ShaderStageFlagBits::TessellationEvaluation: return VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT;
    ...
    inline VkImageUsageFlags Convert(const TextureUsageFlags& value)
    {
        ...
        if (value & TextureUsageFlagBits::ColorAttachment)
            flags |= VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT;
        if (value & TextureUsageFlagBits::DepthStencilAttachment)
