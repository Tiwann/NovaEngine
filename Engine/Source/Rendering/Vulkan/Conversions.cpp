...
{
    template <>
    VkFormat Convert<VkFormat, Format>(const Format& value)
    {
        switch (value)
        {
    ...
    template <>
    VkPresentModeKHR Convert<VkPresentModeKHR, PresentMode>(const PresentMode& value)
    {
        switch (value)
        {
    ...
    template <>
    VkFilter Convert<VkFilter, Filter>(const Filter& filter)
    {
        switch (filter)
        {
    ...
    template <>
    VkPrimitiveTopology Convert<VkPrimitiveTopology, PrimitiveTopology>(const PrimitiveTopology& value)
    {
        switch (value)
        {
    ...
    template <>
    VkCullModeFlags Convert<unsigned, CullMode>(const CullMode& value)
    {
        switch (value)
        {
    ...
    template <>
    VkFrontFace Convert<VkFrontFace, FrontFace>(const FrontFace& value)
    {
        switch (value)
        {
    ...
    template <>
    VkPolygonMode Convert<VkPolygonMode, PolygonMode>(const PolygonMode& value)
    {
        switch (value)
        {
    ...
    template <>
    VkCompareOp Convert<VkCompareOp, CompareOperation>(const CompareOperation& value)
    {
        switch (value)
        {
    ...
    template <>
    VkSamplerAddressMode Convert<VkSamplerAddressMode, SamplerAddressMode>(const SamplerAddressMode& value)
    {
        switch (value)
        {
    ...
    template <>
    VkBlendOp Convert<VkBlendOp, BlendOperation>(const BlendOperation& value)
    {
        switch (value)
        {
    ...
    template <>
    VkBlendFactor Convert<VkBlendFactor, BlendFactor>(const BlendFactor& value)
    {
        switch (value) {
    ...
    template <>
    VkIndexType Convert<VkIndexType, Format>(const Format& value)
    {
        switch (value)
        {
    ...
    template <>
    VkDescriptorType Convert<VkDescriptorType, BindingType>(const BindingType& value)
    {
        switch (value)
        {
    ...
    template <>
    VkSamplerMipmapMode Convert<VkSamplerMipmapMode, Filter>(const Filter& value)
    {
        switch (value)
        {
    ...
    template <>
    VkAttachmentLoadOp Convert<VkAttachmentLoadOp, LoadOperation>(const LoadOperation& value)
    {
        switch (value)
        {
    ...
    template <>
    VkAttachmentStoreOp Convert<VkAttachmentStoreOp, StoreOperation>(const StoreOperation& value)
    {
        switch (value)
        {
    ...
    template <>
    VkShaderStageFlags Convert<unsigned, Flags<ShaderStageFlagBits>>(const ShaderStageFlags& value)
    {
    ...
    template <>
    VkShaderStageFlagBits Convert<VkShaderStageFlagBits, ShaderStageFlagBits>(const ShaderStageFlagBits& value)
    {
        switch (value)
        {
    ...
    template <>
    VkResolveModeFlagBits Convert<VkResolveModeFlagBits, ResolveMode>(const ResolveMode& value)
    {
        switch (value)
        {
    ...
    template <>
    VkAccessFlags Convert<unsigned, Flags<AccessFlagBits>>(const AccessFlags& value)
    {
    ...
    template <>
    VkImageLayout Convert<VkImageLayout, ResourceState>(const ResourceState& value)
    {
        switch (value)
        {
    ...
    template <>
    VkImageUsageFlags Convert<unsigned, Flags<TextureUsageFlagBits>>(const TextureUsageFlags& value)
    {
    ...
    template <>
    VkImageAspectFlags Convert<unsigned, Flags<TextureAspectFlagBits>>(const TextureAspectFlags& value)
    {
    ...
    template <>
    VkImageType Convert<VkImageType, TextureDimension>(const TextureDimension& value)
    {
        switch (value)
        {
        case TextureDimension::None: return static_cast<VkImageType>(0);
        ...
        default: return static_cast<VkImageType>(0);
        }
    }
}
