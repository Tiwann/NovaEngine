...
namespace Nova
{
    ...
    public:
        ...
        virtual bool BindTextures(uint32_t binding, const Nova::ITexture* const* textures, size_t textureCount, BindingType bindingType) = 0;
        virtual bool BindTexture(uint32_t binding, const Nova::ITexture& texture, BindingType bindingType) = 0;
        virtual bool BindSampler(uint32_t binding, const Nova::Sampler& sampler) = 0;
        virtual bool BindCombinedSamplerTexture(uint32_t binding, const Nova::Sampler& sampler, const Nova::ITexture& texture) = 0;
        virtual bool BindCombinedSamplerTextures(uint32_t binding, const Nova::Sampler& sampler, const Nova::ITexture* const* textures, size_t textureCount) = 0;
